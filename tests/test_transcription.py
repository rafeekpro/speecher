...
from tests.test_utils import (
    ...
    save_sample_transcription_to_file
)
...
class TestTranscriptionModule(unittest.TestCase):
    ...
    def test_process_transcription_result_unexpected_error(self):
        ...
        with patch('src.speecher.transcription.process_transcription_result', 
                  side_effect=Exception("Unexpected error")) as mock_process:
