...
class TestProjectManagementAPI:
    ...
    def test_project_recordings(self, auth_client_with_user):
        ...
        for i in range(3):
            ...
            client.post(f"/api/projects/{project_id}/recordings", 
                       json=recording_data, headers=headers)
    ...
    def test_add_recording_to_project(self, auth_client_with_user):
        ...
        response = client.post(f"/api/projects/{project_id}/recordings", 
                              json=recording_data, headers=headers)
    ...
    def test_project_tags(self, auth_client_with_user):
        ...
        response = client.post(f"/api/projects/{project_id}/tags", 
                              json=new_tags, headers=headers)
    ...
    def test_remove_project_tags(self, auth_client_with_user):
        ...
        response = client.request("DELETE", f"/api/projects/{project_id}/tags", 
                                json=remove_tags, headers=headers)
    ...
    def test_search_projects(self, auth_client_with_user):
        ...
        assert response.status_code == 200
        data = response.json()
        assert all("ai" in p["tags"] and "speech" in p["tags"] 
    ...
    def test_project_access_control(self, client: TestClient):
        ...
        response = client.put(f"/api/projects/{project_id}", 
                             json=update_data, headers=users[1])
        assert response.status_code == 403
