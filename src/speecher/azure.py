...
from azure.storage.blob import BlobServiceClient, ContainerClient, BlobClient, generate_container_sas, ContainerSasPermissions
from azure.core.exceptions import ResourceExistsError, ResourceNotFoundError
from azure.cognitiveservices.speech import SpeechConfig, audio, SpeechRecognizer, ResultReason, CancellationDetails
...
def cleanup_resources(storage_account_connection_string, container_name, subscription_key=None, region=None, job_id=None):
    """
